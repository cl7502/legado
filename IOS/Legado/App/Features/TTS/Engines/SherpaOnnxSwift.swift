...
///
/// 注意：此文件需要 onnxruntime 静态库。在 Xcode Build Settings 的
/// Other Swift Flags 中添加 -DSHERPA_ONNX_ENABLED 来启用，同时确保
/// onnxruntime.xcframework 已加入 Link Binary With Libraries。
